# -*- coding: utf-8 -*-
#
# python-omnibot-receiver documentation build configuration file
#
...
extlinks = {
    'repo': ('https://github.com/lyft/python-omnibot-receiver/blob/{}/%s'.format(blob_sha), ''),
    'api': ('https://github.com/lyft/python-omnibot-receiver/blob/{}/api/%s'.format(blob_sha), ''),
}
...
project = u'python-omnibot-receiver'
...
#html_title = u'python-omnibot-receiver v1.0.0'
